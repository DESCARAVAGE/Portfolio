 ...
 */
final class Version20230331082752 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE profil (id INT AUTO_INCREMENT NOT NULL, dan VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, purpose LONGTEXT NOT NULL, more_detail LONGTEXT NOT NULL, image VARCHAR(255) NOT NULL, curriculum_vitae VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
